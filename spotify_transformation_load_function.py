...
def lambda_handler(event, context):
    s3 = boto3.client('s3')
    Bucket = "spotify-etl-project-data-sachin"
    ...
    for data in spotify_data:
        ...
        songs_key = "transform_data/songs_data/songs_transformed_" + str(datetime.now()) + ".csv"
    ...
    for key in spotify_keys:
        ...
        s3_resource.meta.client.copy(copy_source, Bucket, 'raw_data/alreadyprocessed/' + key.split("/")[-1])    
